...
(function() {
  ...
  const dropBelowBtn = $('.js-drop-below .js-open-drop');
  ...
  closeBtn.on('click', function(e) {
    e.preventDefault();
    const _this = $(this);
    const thisShoppingDrop = _this.parents('.js-drop');
  ...
  BODY.on('click', e => {
    if ($(e.target).closest('.js-drop-below').length) return;
    $('.js-close-drop').trigger('click');
  });
})();
